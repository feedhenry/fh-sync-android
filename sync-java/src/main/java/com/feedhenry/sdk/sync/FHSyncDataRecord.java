...
public class FHSyncDataRecord {
    ...
    public FHSyncDataRecord(UtilFactory utilFactory) {
        this.utilFactory = utilFactory;
    }

    public FHSyncDataRecord(UtilFactory utilFactory, JSONObject data) throws JSONException {
        this.utilFactory = utilFactory;
        setData(data);
    }

    public FHSyncDataRecord(UtilFactory utilFactory, String uid, JSONObject data) throws JSONException {
        this.uid = uid;
        this.utilFactory = utilFactory;
        setData(data);
    }
    ...
    public static FHSyncDataRecord fromJSON(UtilFactory utilFactory, JSONObject obj) throws JSONException {
        FHSyncDataRecord record = new FHSyncDataRecord(utilFactory);
        if (obj.has(KEY_UID)) {
