...
public class FHSyncService extends IntentService {
     ...
     * @param config config
     */
    public void setConfig(@NotNull FHSyncConfig config) {
        syncConfig = config;
     ...
     */
    public void setCloudUrl(@NotNull String url) {
        cloudURL = url;
     ...
     * @param listener
     */
    public void registerListener(@NotNull FHSyncListener listener) {
     ...
     * @param listener
     */
    public void unregisterListener(@NotNull FHSyncListener listener) {
        for (Iterator<WeakSyncListener> i = syncListeners.iterator(); i.hasNext(); ) {
            WeakSyncListener syncListener = i.next();
